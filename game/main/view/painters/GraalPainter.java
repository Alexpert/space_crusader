...
public class GraalPainter implements IPainter {
	
	Entity entity;
	Image texture;
	
	public GraalPainter(Entity entity) {
		this.entity = entity;
		this.texture = TextureProvider.getInstance().getTexture("assets/entities/graal.png");
	}
